...
def int_to_bytearray(value: int, num_byte: int = _BLOCK_SIZE_KUZNECHIK) -> bytearray:
    return bytearray(
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(572, 590)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 60, 550, 500))
        ...
        self.enc_inp = QtWidgets.QPlainTextEdit(self.horizontalLayoutWidget)
        self.enc_inp.setObjectName("enc_inp")
        self.verticalLayout.addWidget(self.enc_inp)
        ...
        self.enc_out = QtWidgets.QPlainTextEdit(self.horizontalLayoutWidget)
        self.enc_out.setObjectName("enc_out")
        self.verticalLayout.addWidget(self.enc_out)
        ...
        self.dec_inp = QtWidgets.QPlainTextEdit(self.horizontalLayoutWidget)
        self.dec_inp.setObjectName("dec_inp")
        self.verticalLayout_2.addWidget(self.dec_inp)
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.verticalLayout_2.addItem(spacerItem2)
        self.decrypt = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.decrypt.setObjectName("decrypt")
        self.verticalLayout_2.addWidget(self.decrypt)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.verticalLayout_2.addItem(spacerItem3)
        self.dec_out = QtWidgets.QPlainTextEdit(self.horizontalLayoutWidget)
        self.dec_out.setObjectName("dec_out")
        self.verticalLayout_2.addWidget(self.dec_out)
        ...
        self.textEdit.setGeometry(QtCore.QRect(60, 20, 501, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Кузнечик"))
        self.label.setText(_translate("MainWindow", "Зашифровать"))
        self.enc_inp.setPlaceholderText(_translate("MainWindow", "Введите значение..."))
        self.encrypt.setText(_translate("MainWindow", "Зашифровать"))
        self.enc_out.setPlaceholderText(_translate("MainWindow", "Результат будет здесь..."))
        self.label_2.setText(_translate("MainWindow", "Расшифровать"))
        self.dec_inp.setPlaceholderText(_translate("MainWindow", "Введите значение..."))
        self.decrypt.setText(_translate("MainWindow", "Расшифровать"))
        self.dec_out.setPlaceholderText(_translate("MainWindow", "Результат будет здесь..."))
        self.textEdit.setPlaceholderText(_translate("MainWindow", "Введите ключ..."))
...
class App(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def _get_encryptor(self) -> GOST34122015Kuznechik or None:
        key = self.textEdit.toPlainText()
        if key.isdigit():
            return GOST34122015Kuznechik(key=int_to_bytearray(value=int(key), num_byte=_KEY_SIZE))
        else:
            QtWidgets.QMessageBox.warning(self, 'Ошибка', 'Ключ должен быть числом.')
            return None

    def _encrypt(self):
        inp = self.enc_inp.toPlainText()
        encryptor = self._get_encryptor()
        if encryptor is not None:
            if inp.isdigit():
                result = encryptor.encrypt(int_to_bytearray(value=int(inp)))
                self.enc_out.clear()
                self.enc_out.setPlainText(str(bytearray_to_int(result)))
            else:
                QtWidgets.QMessageBox.warning(self, 'Ошибка', 'Значение должно быть числом.')

    def _decrypt(self):
        inp = self.dec_inp.toPlainText()
        encryptor = self._get_encryptor()
        if encryptor is not None:
            if inp.isdigit():
                result = encryptor.decrypt(int_to_bytearray(value=int(inp)))
                self.dec_out.clear()
                self.dec_out.setPlainText(str(bytearray_to_int(result)))
            else:
                QtWidgets.QMessageBox.warning(self, 'Ошибка', 'Значение должно быть числом.')
